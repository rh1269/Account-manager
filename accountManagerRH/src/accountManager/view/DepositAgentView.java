...
import accountManager.controller.DepositAgentController;
...
public class DepositAgentView extends JFrameView {
	...
	public DepositAgentView(AccountsModel model, DepositAgentController controller, int pick)
	{
		...
		//this.setTitle(user + "  ");
		this.setTitle("Create Deposit Agent");
	...
	{ 
		System.out.println(amountInDollarsFieldText);
	...
	class Handler implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			((DepositAgentController)getController()).operation(e.getActionCommand());
		}
	}
